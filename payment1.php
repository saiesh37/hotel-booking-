       ...
       <body>
             <div class="border">
                     ...
                     <div class="margin">
                         ...
                         <div class="bill">
                                   <p class="name">GET SET EAT.COM</p>
...
<a href="res1.html"><h1>CLICKHERE TO ORDERFOOD</H1></a>
<a href="payment1.php"><input type="button" value="YES" ></a>

<a href="payment.php"> <input type="button" value="NO" ></a>
