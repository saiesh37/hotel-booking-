		...
		<div class="image">
			...
			<div class="register">
				...
				<form method="post">
					...
					<input class="box" name="password" type=password placeholder="    password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain atleast one number and one uppercase and lowercase letter,and at least 8 or more characters" required /></br>
